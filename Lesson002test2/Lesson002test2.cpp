...
// Lesson002test2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLesson002test2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLesson002test2App

CLesson002test2App::CLesson002test2App()
{
...
// Единственный объект CLesson002test2App

CLesson002test2App theApp;


// Инициализация CLesson002test2App

BOOL CLesson002test2App::InitInstance()
{
