...
// Lesson010.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLesson010App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLesson010App

CLesson010App::CLesson010App()
{
...
// Единственный объект CLesson010App

CLesson010App theApp;


// Инициализация CLesson010App

BOOL CLesson010App::InitInstance()
{
