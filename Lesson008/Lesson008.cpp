...
// Lesson008.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLesson008App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLesson008App

CLesson008App::CLesson008App()
{
...
// Единственный объект CLesson008App

CLesson008App theApp;


// Инициализация CLesson008App

BOOL CLesson008App::InitInstance()
{
